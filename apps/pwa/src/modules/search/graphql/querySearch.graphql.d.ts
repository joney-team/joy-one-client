...
export type SearchQueryVariables = Types.Exact<{
  ...
  entities?: Types.InputMaybe<Array<Types.Scalars['String']['input']>>;
  limit?: Types.InputMaybe<Types.Scalars['Int']['input']>;
}>;


export type SearchQuery = { __typename: 'Query', search: Array<
    | { __typename: 'SearchResultBase', id: string, entity: string }
    ...
    | { __typename: 'SearchResultLoan', code: string, customerName: string, customerPhone: string | null, imeil: string | null, status: string | null, id: string, entity: string }
    ...
    | { __typename: 'SearchResultProduct', name: string, type: string, id: string, entity: string }
    | { __typename: 'SearchResultReceipt', code: string, note: string, id: string, entity: string }
