...
type OnModalConnectMetaPages = (args: ModalConnectMetaPagesArgs) => void;

export interface ModalConnectMetaPagesRef {
  open: OnModalConnectMetaPages;
}

export const ModalConnectMetaPages = forwardRef<
...
>(({ children }, ref) => {
  ...
  const onOpen: OnModalConnectMetaPages = (p) => {
