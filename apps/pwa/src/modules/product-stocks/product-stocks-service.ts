...
export async function getProductStockRecords(query?: any) {
  return api.get<ResponseList<ProductStockRecordEntity>>('/product-stocks/records', { params: query })
}

export async function getProductStocks(query?: any) {
  return api.get<ResponseList<ProductStockEntity>>('/product-stocks', { params: query })
}

export async function multipleProductsStockIn(dto: MultipleProductsStockInDto) {
  return api.post('/product-stocks/stock-in/multiple', dto)
}

export async function productStockOut(dto: ProductStockOutDto) {
  return api.post('/product-stocks/stock-out', dto)
}
