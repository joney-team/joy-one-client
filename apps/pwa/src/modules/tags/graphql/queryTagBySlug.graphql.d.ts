...
export const TagBySlugDocument = (import("graphql").DocumentNode) as TypedDocumentNode<TagBySlugQuery, TagBySlugQueryVariables>;
export default TagBySlugDocument 