...
import {
  ...
  IconDatabase, IconEyeglass, IconLayoutList, IconMinus, IconPointFilled, IconTestPipe
...
export const getTaskEntity = (id?: string | undefined | null) => id ? taskEntities[id] : undefined;

export const getTaskEntityByCode = (code?: string | undefined | null) => Object.values(taskEntities).find(v => v.code === code);
