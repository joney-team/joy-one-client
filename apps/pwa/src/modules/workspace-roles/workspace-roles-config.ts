...
export const permissionGroups: {
  ...
  [PermissionGroupKey.LOANS]: {
    ...
    permissions: [
      ...
      { value: WorkspacePermission.LOANS_UPDATE_WORKSPACE_BRANCH, dependentPermissions: [WorkspacePermission.LOANS_VIEW] },
      { value: WorkspacePermission.LOANS_ARCHIVE, dependentPermissions: [WorkspacePermission.LOANS_VIEW] },
    ]
  },
  [PermissionGroupKey.CUSTOMERS]: {
    permissions: [
      { value: WorkspacePermission.CUSTOMERS_VIEW },
      { value: WorkspacePermission.CUSTOMERS_CREATE, dependentPermissions: [WorkspacePermission.CUSTOMERS_VIEW] },
      { value: WorkspacePermission.CUSTOMERS_VIEW_CONTACT, dependentPermissions: [WorkspacePermission.CUSTOMERS_VIEW] },
      { value: WorkspacePermission.CUSTOMERS_UPDATE_INFO, dependentPermissions: [WorkspacePermission.CUSTOMERS_VIEW, WorkspacePermission.CUSTOMERS_VIEW_CONTACT] },
      { value: WorkspacePermission.CUSTOMERS_ASSIGN, dependentPermissions: [WorkspacePermission.CUSTOMERS_VIEW] },
      { value: WorkspacePermission.CUSTOMERS_ARCHIVE, dependentPermissions: [WorkspacePermission.CUSTOMERS_VIEW] },
      { value: WorkspacePermission.CUSTOMER_KYCS_MANAGER, dependentPermissions: [WorkspacePermission.CUSTOMERS_UPDATE_INFO] },
      { value: WorkspacePermission.MESSAGE_BOXES_MANAGER, dependentPermissions: [WorkspacePermission.CUSTOMERS_VIEW] },
  ...
  [PermissionGroupKey.PROMOTIONS]: {
    permissions: [
      ...
      { value: WorkspacePermission.PRODUCT_COMBOS_MANAGER, dependentPermissions: [WorkspacePermission.PRODUCT_COMBOS_VIEW, WorkspacePermission.PRODUCTS_SERVICES_WRITE] },
    ]
  },
  [PermissionGroupKey.BOOKINGS]: {
    permissions: [
      { value: WorkspacePermission.BOOKING_VIEW },
      { value: WorkspacePermission.BOOKING_MANAGER, dependentPermissions: [WorkspacePermission.BOOKING_VIEW, WorkspacePermission.CUSTOMERS_VIEW] },
    ]
  },
  ...
  [PermissionGroupKey.ORDERS]: {
    ...
    permissions: [
      ...
      { value: WorkspacePermission.ORDERS_CREATE, dependentPermissions: [WorkspacePermission.ORDERS_VIEW, WorkspacePermission.CUSTOMERS_VIEW, WorkspacePermission.RECEIPTS_CREATE] },
      { value: WorkspacePermission.ORDERS_UPDATE, dependentPermissions: [WorkspacePermission.ORDERS_VIEW] },
      { value: WorkspacePermission.ORDERS_ARCHIVE, dependentPermissions: [WorkspacePermission.ORDERS_VIEW] },
    ]
  },
  [PermissionGroupKey.PRODUCTS_SERVICES]: {
    permissions: [
      { value: WorkspacePermission.PRODUCTS_SERVICES_WRITE },
    ]
  },
  [PermissionGroupKey.PRODUCT_STOCKS]: {
    permissions: [
      { value: WorkspacePermission.PRODUCT_STOCK_VIEW },
      { value: WorkspacePermission.PRODUCT_STOCK_IN, dependentPermissions: [WorkspacePermission.PRODUCTS_SERVICES_WRITE, WorkspacePermission.PRODUCT_STOCK_VIEW] },
      { value: WorkspacePermission.PRODUCT_STOCK_IN_REVERT, dependentPermissions: [WorkspacePermission.PRODUCTS_SERVICES_WRITE, WorkspacePermission.PRODUCT_STOCK_VIEW] },
      { value: WorkspacePermission.PRODUCT_STOCK_OUT, dependentPermissions: [WorkspacePermission.PRODUCTS_SERVICES_WRITE, WorkspacePermission.PRODUCT_STOCK_VIEW] },
      { value: WorkspacePermission.PRODUCT_STOCK_OUT_REVERT, dependentPermissions: [WorkspacePermission.PRODUCTS_SERVICES_WRITE, WorkspacePermission.PRODUCT_STOCK_VIEW] },
    ]
  },
  [PermissionGroupKey.PRESCRIPTIONS]: {
    workspaceTypes: [WorkspaceType.CLINIC, WorkspaceType.DENTAL, WorkspaceType.HOSPITAL],
    permissions: [
      { value: WorkspacePermission.PRESCRIPTIONS_WRITE },
    ]
  },
  [PermissionGroupKey.PARTNERS]: {
    permissions: [
      { value: WorkspacePermission.PARTNERS_WRITE },
    ]
  },
  [PermissionGroupKey.MEMBERS]: {
    permissions: [
      { value: WorkspacePermission.WORKSPACE_MEMBERS_VIEW },
      { value: WorkspacePermission.WORKSPACE_MEMBERS_MANAGER, dependentPermissions: [WorkspacePermission.WORKSPACE_MEMBERS_VIEW] },
    ]
  },
  ...
  [PermissionGroupKey.REPORTS]: {
    permissions: [
      { value: WorkspacePermission.REPORTS_VIEW },
    ]
  },
}