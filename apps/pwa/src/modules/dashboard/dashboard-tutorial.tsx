          ...
          viewport.view === "mobile"
            ...
            : [
                ...
                },
                {
                  ...
                  content: (
                    <Text>
                      Hiển thị lịch hẹn <strong>#Bookings</strong> hôm nay, có thể lọc theo trạng thái đang xử lí hoặc
                      tất cả
                    </Text>
                  ),
                },
                  ...
                  content: (
                    <Stack>
                      ...
                      {workspace.hasPermission(WorkspacePermission.WORKSPACE_SETTINGS) && (
                        <>
                          <Text>
                            <strong>#Ngân hàng</strong> thiết lập tài khoản ngân hàng nhận tiền thanh toán
                          </Text>
                          <Text>
                            <strong>#Zalo OA</strong> thiết lập kết nối với Zalo Official Accounts (Liên hệ đội ngũ
                            Support)
                          </Text>
                          <Text>
