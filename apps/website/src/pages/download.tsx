...
import { Anchor, Box, Center, Container, Group, Image, Stack, Text, ThemeIcon, Title, em } from '@mantine/core';
            ...
            <Stack>
              ...
              <Stack py={100}>
                <Stack gap={20}>
                  ...
                  <Title fz={em(30)} fw={500} tt="uppercase" c="primary" ta="center">Phần Mềm Trên Máy Tính</Title>
